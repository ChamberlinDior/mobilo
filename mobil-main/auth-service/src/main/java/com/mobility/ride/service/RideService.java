...
//
//  ☆ AJOUTS PRINCIPAUX
//    • listHistory(riderId)     – renvoie l’historique du rider
//    • toResponse()             – renseigne pickupAddress / dropoffAddress
//
//  NB : les adresses sont résolues « à la volée » via un composant
//       GeoService (reverse-geocoding).
// ─────────────────────────────────────────────────────────────
...
public class RideService {
    ...
    private final GeoService geoService;       // ★ NEW (reverse‐geocoding)
    ...
    public RideResponse requestRide(RequestRideRequest req) {
        ...
        Ride ride = Ride.builder()
                ...
                // ─── Ajout des champs tarifaires pour la requête immédiate ─────────
    ...
    public List<RideResponse> listHistory(Long riderId) {
        //  ➜ simple : toute la table, filtrée par rider + tri décroissant
    ...
    private RideResponse toResponse(Ride r) {
        ...
        // Géocodage inverse à la volée (ou récupéré depuis la BDD).
