...
@Mapper(
        ...
        unmappedTargetPolicy = ReportingPolicy.ERROR   // on garde la sûreté
)
public interface PricingMapper {
    ...
    @Mapping(target = "surgeActive",
            expression =
                    "java(src.getFactor()!=null && src.getFactor().doubleValue() > 1.0)")
    ...
    // ► NOUVEAUX CHAMPS NON REMPLIS POUR L'INSTANT
